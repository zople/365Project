...
public class TblProduct implements Serializable {
    ...
    @ManyToOne
    private TblEnterprise enterpriseId;
    ...
    public TblEnterprise getEnterpriseId() {
        return enterpriseId;
    }

    public void setEnterpriseId(TblEnterprise enterpriseId) {
    ...
    public String toString() {
        return "com.zople.dal.domain.TblProduct[ id=" + id + " ]";
    }
